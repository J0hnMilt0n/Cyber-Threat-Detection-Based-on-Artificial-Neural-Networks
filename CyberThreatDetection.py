...
from tkinter import messagebox, Button, Text, filedialog, simpledialog, Tk
import tkinter
...
main = tkinter.Tk()
main.title("Artificial Intelligence based Cyber security threats identification in Financial Institutions using Machine learning ") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Artificial Intelligence based Cyber security threats identification in Financial Institutions using Machine learning ')
